...
<?php
$filz=fopen("data/".date("m-d-y").".txt","a");
fwrite($filz,"\n");
fclose($filz);
?>
<!DOCTYPE html>
...
<p style="margin-left:20px;"><?php echo $visitors_count. " visits since Feb 26,2011 6:00AM "; ?> (<i>Last Update: Feb 26, 2012 [1 Year completion]</i>)</p>
...
<p style='position:absolute;right:-90px;top:280px'><a href="javascript:void(0);" onclick='popupWin("https://facebook.com/sharer.php?u=<?php echo urlencode('http://home.iitk.ac.in/~hrgupta/instant/'); ?>","700","400")'><img src='smile.png' style='width:64px;height:64px;border:none;box-shadow:none' title='5K visits in year'/></a></p>
<div class="qA">
	...
	<p>Also other than hall-1 & hall9, if you have mess-bill excelsheet of your hostel, you can mail it to <a href='mailto:hrgupta@iitk.ac.in'>hrgupta@iitk.ac.in</a>. Will be updated after mid sem.</p>
</div>
</div>
</div>
<div id="footer">
